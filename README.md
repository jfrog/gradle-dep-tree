...
contain a build.gradle file. To generate a dependency tree for each project that contains a build file, set the `-Dcom.jfrog.includeAllBuildFile` flag to `true`.
